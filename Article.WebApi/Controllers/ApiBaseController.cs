...
namespace Article.WebApi.Controllers
{
    public class ApiBaseController : ApiController
    {
        ...
        public HttpResponseMessage NotValidMessage(string message)
        {
            //return Request.CreateErrorResponse(HttpStatusCode.NotFound, message);
            return Request.CreateResponse(HttpStatusCode.NotAcceptable, new { Message = message });
        }

        public HttpResponseMessage NotEnoughMoney(string message)
        {
            //return Request.CreateErrorResponse(HttpStatusCode.NotFound, message);
            return Request.CreateResponse(HttpStatusCode.PaymentRequired, new { Message = message });
        }
    }
}
