...
{
    public class IsArabicNameAddUniquePropertyValidator : PropertyValidator
    {
        public readonly ICityService _cityService;
        public IsArabicNameAddUniquePropertyValidator(ICityService CityService)
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
           // string email = context.PropertyValue as string;
            ...
            return _cityService.IsNameUnique(m.ArabicCityName,null);
        }
    }
}
