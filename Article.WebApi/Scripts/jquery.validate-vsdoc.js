...
$.extend($.validator, {
	...
	messages: {
		...
		creditArticle: "Please enter a valid credit Article number.",
	...
	classRuleSettings: {
		...
		digits: {digits: true},
		creditArticle: {creditArticle: true}
	},
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/creditArticle
		// based on http://en.wikipedia.org/wiki/Luhn
		creditArticle: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
