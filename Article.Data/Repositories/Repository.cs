...
namespace Article.Data.Repositories
{
    internal class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public List<TEntity> get(System.Linq.Expressions.Expression<Func<TEntity, bool>> predicate,int page,int pageSize)
        {
            int skip = (page - 1) * pageSize;
            return Set.OrderBy(predicate).Skip(skip).Take(pageSize).ToList();
