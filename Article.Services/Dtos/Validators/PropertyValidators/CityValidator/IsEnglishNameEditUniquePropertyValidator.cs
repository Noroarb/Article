...
{
    public class IsEnglishNameEditUniquePropertyValidator : PropertyValidator
    {
        public readonly ICityService _cityService;
        public IsEnglishNameEditUniquePropertyValidator(ICityService CityService)
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
           // string email = context.PropertyValue as string;
            ...
            return _cityService.IsNameUnique(m.EnglishCityName,m.Id);
        }
    }
}
